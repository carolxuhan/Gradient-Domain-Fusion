...
if DO_BLEND
    ...
    im_background = imresize(im2double(imread('./samples/painting.jpg')), 0.25, 'bilinear');
    im_object = imresize(im2double(imread('./samples/robert.jpg')), 0.25, 'bilinear');
